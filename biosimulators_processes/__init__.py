...
from biosimulators_processes.helpers import register_module
...
PROCESSES_TO_REGISTER = [
    ...
    ('copasi', 'copasi_process.Copasi'),
    ('cobra', 'fba_process.Cobra'),
...
register_module(STEPS_TO_REGISTER, CORE, verbose=False)
