...
class SimpleMembraneProcess(Process):
    ...
    def __init__(self, config: Dict[str, Union[Dict[str, float], str]] = None, core: ProcessTypes = None):
        ...
        if mesh_file is not None:
            ...
            self.initial_faces, self.initial_vertices = mesh_constructor(radius=0.3, subdivision=0)
    ...
    def update(self, state, interval):
        ...
        previous_faces = np.array(previous_geometry["faces"])
        previous_vertices = np.array(previous_geometry["vertices"])
        ...
        return {
            "geometry": {'faces': previous_faces, 'vertices': previous_vertices},  # geometry_out,
            # "parameters": param_data_k,
            "velocities": [[0.0]]  # velocities_k
        }
